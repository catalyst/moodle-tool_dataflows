...
final class flow_cap extends flow_step {
    ...
    public function get_iterator(): iterator {
        ...
        // $upstream = end($this->enginestep->upstreams);
        // echo"<pre>";print_r(key($this->enginestep->upstreams));die;
        // echo"<pre>";print_r(count($this->enginestep->upstreams));die;
        // $upstream = $this->enginestep->upstreams;
