 ...
 */
class connector_sftp_directory_file_list extends connector_step {
    ...
    public function execute($input = null) {
        ...
        $variables->set('vars.filenames', $list);
        return $input;
    }
    ...
    public function define_outputs(): array {
        return [
            'filenames' => get_string('directory_file_list:filenames', 'tool_dataflows'),
        ];
    }
}
