...
$string['field_config_help'] = "Config variables that can be accessed via expressions within all dataflow steps as \${{dataflows.config.&lt;name&gt;}}.
    Values are defined in YAML format, with nested values being converted into a dot separated sequence.\n
    Example.
    abc:
      def: 12  # Accessed as \${{dataflows.config.abc.def}}";
