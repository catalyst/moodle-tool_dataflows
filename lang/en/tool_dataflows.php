...
$string['available_fields_help'] = 'The fields listed below can be referenced in any step configuration, e.g. {$a}, <br> You can copy the expression by click the desired configuration';
