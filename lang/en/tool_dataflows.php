...
$string['stepinvalidinputconnectorcount'] = 'Invalid number of input connectors (Found: {$a->found}, Expected between {$a->min} and {$a->max}).';
$string['stepinvalidoutputconnectorcount'] = 'Invalid number of output connectors (Found: {$a->found}, Expected between {$a->min} and {$a->max}).';
