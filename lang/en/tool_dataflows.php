...
$string['reader_json:arraykey_help'] = 'Nested array to extract from JSON. For example, <code>data.list.users</code> will return the users array from the following JSON (If empty it is assumed the starting point of the JSON file is an array):</br>';
$string['reader_json:arraysort'] = 'Sort by';
$string['reader_json:arraysort_help'] = 'Value to sort array by, this value needs to be present in the return array. For the example above, setting this value to <code>userdetails.firstname</code> will return an array sorted by the firstname value in the users array.';
