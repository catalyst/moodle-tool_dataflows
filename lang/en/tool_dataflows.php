...
$string['flow_web_service:field_parameters_help'] = 'Parameters should be in the following JSON format: {$a->json} You can also use the following YAML format: {$a->yaml} Note: Structure depends on webservice called
<br><br> You can reference a value from JSON with the following : <code>data.somekey <br> ie : data.GUID - data.username</code>';
